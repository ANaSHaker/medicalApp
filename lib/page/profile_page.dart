      ...
      builder: (context,state){
        return ThemeSwitchingArea(
          ...
          child: Builder(
            ...
            body:state is GetProfileLoadingState ? Container(
              child: Center(child: CircularProgressIndicator()),
            ) : ListView(
                      ...
                      child: ListView.separated(
                          itemBuilder: (context,index){
                            return Container(
                              child: Column(
                                children: [
                                  Text(AppCubit.get(context).getDiseases[index],style: TextStyle(
                                      fontSize: 18,
                                      color: Colors.white,
                                  ),),
                                ],
                          ...
                          itemCount: AppCubit.get(context).getDiseases.length
                      ),
                    )
